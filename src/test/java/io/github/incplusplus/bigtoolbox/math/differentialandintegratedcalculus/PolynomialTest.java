...
class PolynomialTest {
  private final Polynomial Lily =
      new Polynomial(
          4,
          new Term[] {
            new X(new BigDecimal(4), 4),
            new X(new BigDecimal(30), 3),
            new X(new BigDecimal(12), 1),
            new Constant(new BigDecimal(6))
          },
          4);
  private final Polynomial Lily_original =
      new Polynomial(
          3,
          new Term[] {
            new X(new BigDecimal(4), 4), new X(new BigDecimal(30), 3), new X(new BigDecimal(12), 1)
          },
          4);
  private final Polynomial Melvin =
      new Polynomial(
          2, new Term[] {new X(new BigDecimal(3), 3), new Constant(new BigDecimal(8))}, 3);
