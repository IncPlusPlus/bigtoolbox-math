...
public class X extends Term {
  ...
  /**
   * Returns a BigDecimal value containing the integration of this term This looks messy and it
   * sorta is. Basically, the integration formula of Ax^B is (A/(B+1))x^(B+1)
   *
   * @param in the value to substitute for the variable present in this term.
