...
public class DivisorMath {
  ...
  /**
   * Returns the number of proper divisors of n. For an explanation on how this works, see
   * https://math.stackexchange.com/questions/1118616/find-how-many-positive-divisors-a-number-has-what-would-you-do
   * or, for a simpler explanation see https://www.math.upenn.edu/~deturck/m170/wk2/numdivisors.html
   * To summarize, the product of all of the exponents of the prime factorization of a number
   * increased by 1 is the number of divisors of that number. 144 = 2^4 * 3^2 4 + 1 = 5 and 2 + 1 =
   * 3. 5 * 3 = 15 and there are 15 divisors of 144.
   *
