...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        "Error: "
            + myIntegrator
                .percentError(myIntegrator.exactValue(), myIntegrator.midpointRule())
                .toEngineeringString()
            + "%");
    System.out.println();
    ...
    System.out.println(
        "Error: "
            + myIntegrator
                .percentError(myIntegrator.exactValue(), myIntegrator.trapezoidRule())
                .toEngineeringString()
            + "%");
    System.out.println();
    ...
    System.out.println(
        "Error: "
            + myIntegrator
                .percentError(myIntegrator.exactValue(), myIntegrator.simpsonsRule())
                .toEngineeringString()
            + "%");
    System.out.println();
