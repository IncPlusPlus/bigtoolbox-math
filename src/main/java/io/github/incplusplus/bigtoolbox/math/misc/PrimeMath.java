...
public class PrimeMath {
   ...
   * @return A 2D array with the rows having the bases of each of the distinct prime factors and the
   *     corresponding column containing the exponents for those bases
   */
